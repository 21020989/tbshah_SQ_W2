...
function preload() {
  bgIMG = loadImage("assets/images/Resturant_Background.png");
...
let platforms = [
  ...
  { x: 280, y: 140, w: 140, h: 16 }, // centre platform
  { x: 500, y: 140, w: 120, h: 16 }, // right high platform
  { x: 160, y: 240, w: 100, h: 16 }, // left high platform
